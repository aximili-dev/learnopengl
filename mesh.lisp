...
(defmacro build-mesh ((vertices indices uv-coords) &body body)
  `(let ((,vertices '())
	 (,indices '())
	 (,uv-coords '()))
     ,@body
     (create-mesh ,vertices ,indices ,uv-coords)))


(defun build-cube ()
  (build-mesh (vertices indices uv-coords)
    (push (vertex (vec -0.5 -0.5 -0.5) (vec 0.0  0.0 -1.0)  (vec 0.0  0.0)) vertices)
    (push (vertex (vec 0.5 -0.5 -0.5)  (vec 0.0  0.0 -1.0)  (vec 1.0  0.0)) vertices)
    (push (vertex (vec 0.5  0.5 -0.5)  (vec 0.0  0.0 -1.0)  (vec 1.0  1.0)) vertices)
    (push (vertex (vec 0.5  0.5 -0.5)  (vec 0.0  0.0 -1.0)  (vec 1.0  1.0)) vertices)
    (push (vertex (vec -0.5  0.5 -0.5) (vec 0.0  0.0 -1.0)  (vec 0.0  1.0)) vertices)
    (push (vertex (vec -0.5 -0.5 -0.5) (vec 0.0  0.0 -1.0)  (vec 0.0  0.0)) vertices)
    ...
    (push (vertex (vec -0.5  0.5  0.5) (vec -1.0  0.0  0.0) (vec 1.0  0.0)) vertices)
    (push (vertex (vec -0.5  0.5 -0.5) (vec -1.0  0.0  0.0) (vec 1.0  1.0)) vertices)
    (push (vertex (vec -0.5 -0.5 -0.5) (vec -1.0  0.0  0.0) (vec 0.0  1.0)) vertices)
    (push (vertex (vec -0.5 -0.5 -0.5) (vec -1.0  0.0  0.0) (vec 0.0  1.0)) vertices)
    (push (vertex (vec -0.5 -0.5  0.5) (vec -1.0  0.0  0.0) (vec 0.0  0.0)) vertices)
    (push (vertex (vec -0.5  0.5  0.5) (vec -1.0  0.0  0.0) (vec 1.0  0.0)) vertices)
    ...
    (push (vertex (vec -0.5 -0.5 -0.5) (vec 0.0 -1.0  0.0)  (vec 0.0  1.0)) vertices)
    (push (vertex (vec 0.5 -0.5 -0.5)  (vec 0.0 -1.0  0.0)  (vec 1.0  1.0)) vertices)
    (push (vertex (vec 0.5 -0.5  0.5)  (vec 0.0 -1.0  0.0)  (vec 1.0  0.0)) vertices)
    (push (vertex (vec 0.5 -0.5  0.5)  (vec 0.0 -1.0  0.0)  (vec 1.0  0.0)) vertices)
    (push (vertex (vec -0.5 -0.5  0.5) (vec 0.0 -1.0  0.0)  (vec 0.0  0.0)) vertices)
    (push (vertex (vec -0.5 -0.5 -0.5) (vec 0.0 -1.0  0.0)  (vec 0.0  1.0)) vertices)
